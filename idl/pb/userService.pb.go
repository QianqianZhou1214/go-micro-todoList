...
type UserModel struct {
	...
	Id uint32 `protobuf:"varint,1,opt,name=id,proto3" json:"id" from:"id"`
	// @inject_tag: json:"user_name" from:"user_name"
	UserName string `protobuf:"bytes,2,opt,name=user_name,json=userName,proto3" json:"user_name" from:"user_name"`
	// @inject_tag: json:"created_at" from:"created_at"
	CreatedAt int64 `protobuf:"varint,3,opt,name=created_at,json=createdAt,proto3" json:"created_at" from:"created_at"`
	// @inject_tag: json:"updated_at" from:"updated_at"
	UpdatedAt int64 `protobuf:"varint,4,opt,name=updated_at,json=updatedAt,proto3" json:"updated_at" from:"updated_at"`
	// @inject_tag: json:"deleted_at" from:"deleted_at"
	DeletedAt     int64 `protobuf:"varint,5,opt,name=deleted_at,json=deletedAt,proto3" json:"deleted_at" from:"deleted_at"`
...
type UserRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// @inject_tag: json:"user_name" from:"user_name"
	UserName string `protobuf:"bytes,1,opt,name=user_name,json=userName,proto3" json:"user_name" from:"user_name"`
	// @inject_tag: json:"password" from:"password"
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password" from:"password"`
	// @inject_tag: json:"password_confirm" from:"password_confirm"
	PasswordConfirm string `protobuf:"bytes,3,opt,name=password_confirm,json=passwordConfirm,proto3" json:"password_confirm" from:"password_confirm"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type UserResponse struct {
	...
	UserDetail *UserModel `protobuf:"bytes,1,opt,name=user_detail,json=userDetail,proto3" json:"user_detail" from:"user_detail"`
	// @inject_tag: json:"code" from:"code"
	Code          uint32 `protobuf:"varint,2,opt,name=code,proto3" json:"code" from:"code"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_userService_proto_rawDesc = "" +
	...
	"\x10password_confirm\x18\x03 \x01(\tR\x0fpasswordConfirm\"R\n" +
	"\fUserResponse\x12.\n" +
	"\vuser_detail\x18\x01 \x01(\v2\r.pb.UserModelR\n" +
	"userDetail\x12\x12\n" +
	"\x04code\x18\x02 \x01(\rR\x04code2p\n" +
	"\vUserService\x12.\n" +
	"\tUserLogin\x12\x0f.pb.UserRequest\x1a\x10.pb.UserResponse\x121\n" +
	"\fUserRegister\x12\x0f.pb.UserRequest\x1a\x10.pb.UserResponseB\aZ\x05./;pbb\x06proto3"
...
var file_userService_proto_depIdxs = []int32{
	0, // 0: pb.UserResponse.user_detail:type_name -> pb.UserModel
